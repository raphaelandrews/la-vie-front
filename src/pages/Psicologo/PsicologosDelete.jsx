...
const PsicologosDelete = () => {
  ...
  async function deletePsicologo() {
    try {
      let confirmDelete = confirm("Deseja excuir o psicólogo?");
      if (confirmDelete === false) {
        ...
        alert("Psicólogo excluído!")
        navigate("/dashboard");
      }
    } catch (error) {
      alert("Não foi possível excluir o psicólogo: " + error);
    }
  }
...
export default PsicologosDelete;
